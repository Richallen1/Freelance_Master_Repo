...
- (void)BuildHelpLibrary
{
    ...
    [helpDetail addObject:@"When your in the Invoice screen in the top right hand corener you will see a button labaeled mark as paid. Press this and the table on the left should show the invoice as paid."];
    [helpDetail addObject:@"Select the invoice from the left menu and then nclick the delete button on the right. Alternatively you can swipe on the left menu from right to left and it will show a dete button."];
    [helpDetail addObject:@"No. The data is only stored on the device. Futute versions will have the option to back up with iCloud however this is not available yet."];
